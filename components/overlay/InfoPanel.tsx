...
export default function InfoPanel({
  ...
  return (
    ...
    >
      ...
      */}
      <div
        className={`relative ${maxWidth} w-full max-h-[88vh] flex flex-col`}
        style={{
          background: "#0d0b08",
      ...
      >
        ...
        >
          ...
          {icon && (
            <span
              className="relative z-10 text-xl leading-none select-none"
        ...
        <div className="flex-1 overflow-y-auto pixel-scroll p-5">
          {children}
        </div>
